import { Button, Flex, Image, Link, Text, useMediaQuery } from "@chakra-ui/react";
      ...
      <Flex justify={"center"} w="100%" maxWidth={"1200px"}>
        <Flex w="20%">
          {isLargerThan ? (
            ...
            <Flex w={"80px"} h={"100%"} border={"1px solid #393939"} borderTop={"none"} justify={"center"} align={"center"}>
              <Link href="/" justifyContent={"center"}>
                <Image maxWidth={"30px"} alt="img" src="menu.png" />
              </Link>
            </Flex>
          )}
        </Flex>
        ...
        <Flex w="20%">
          <Flex w={"75%"} border={"1px solid #393939"} justify={"center"} borderTop={"none"}>
            <Flex m={"0px 10px"} justify={"center"} align={"center"}>
              {isLargerThan ? (
                ...
                <Link href="https://github.com/arthurcortezz">
                  <Image maxWidth={"40px"} alt={"git"} src="git.png"></Image>
                </Link>
              )}
            </Flex>
          </Flex>
